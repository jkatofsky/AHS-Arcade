...
function getHighScores(game, amount) {
	var scoresText = fs.readFileSync(__dirname + '/scores.json', 'utf8');
...
function saveScore(scoreData) {
	fs.readFile(__dirname + '/scores.json', 'utf8', function (error, data) {
		...
		fs.writeFile(__dirname + '/scores.json', JSON.stringify(allScores), 'utf8');
	});
}
